...
PLACE = {
    ...
    "J5": (77, 9, 0), "J8": (90, 8, 0), "J2": (95, 24, 0),
    # power band: SMD bulk caps (12mm pitch — wide alu pads) + buck + bypass
    "F1": (37, 15, 0), "D1": (45, 15, 0),
    "C1": (38, 25, 0), "C2": (50, 25, 0), "C_VM": (54, 33, 0),
    "U1": (67, 23, 0), "C3": (73, 31, 0),
    ...
    "T1": (74, 47, 0), "R3": (70, 53, 90), "C7": (70, 47, 90),
